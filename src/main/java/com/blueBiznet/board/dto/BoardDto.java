package com.blueBiznet.board.dto;
...
public class BoardDto {
	...
	// 매개변수 생성자
	public BoardDto(int num,  String title, String content,  String name, String writeDatetime, String writeUpdateDatetime,  ArrayList<BoardDto> list, String email) {
		super();
		this.num = num;
		this.title = title;
